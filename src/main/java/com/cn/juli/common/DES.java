...
public class DES{
     ...
     * @throws Exception
     */
    public static void encrypt(String HexString,String keyStr) throws Exception{
        try {
            byte[] theKey = null;
            byte[] theMsg = null;
     ...
     * @throws Exception
     */
    public static void decode(String hexStr,String keyStr,String modeStr) throws Exception{
